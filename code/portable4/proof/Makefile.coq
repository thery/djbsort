...
# They can also be put in Makefile.coq.local once and for all.
...
# put in Makefile.coq.local double colon rules accordingly.
...
#
# There rules can be extended in Makefile.coq.local
...
# extension points and Makefile.coq.local
printenv::
	$(warning printenv is deprecated)
	$(warning write extensions in Makefile.coq.local or include Makefile.coq.conf)
	@echo 'COQLIB = $(COQLIB)'
...
# file you can extend the merlin-hook target in Makefile.coq.local
.merlin:
	$(SHOW)'FILL .merlin'
...
# Users can create Makefile.coq.local-late to hook into double-colon rules
